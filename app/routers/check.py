...
def check_dialogue(
    ...
    detected = process_risk_detection(http_request.app.state.llm_client, raw_text)
    predicted_red_flags = [RedFlagItem(category=one_flag["category"]) for one_flag in detected]
